...
<title>WALL ST. DREAM — 에이헨 메이슨</title>
<style>
  :root{
    --bone:#EFEAE1;
    --ink:#0E0D0C;
    ...
    --hpad:24px;           /* 좌우 여백 — 히어로 글자 크기 계산의 기준 */
    --fill:4.05;           /* 6글자 대문자 1줄이 화면을 꽉 채우는 비율 상수 */
  ...
  *{box-sizing:border-box}
  ...
  .wrap{max-width:1240px;margin:0 auto;padding:0 var(--hpad)}
  img{display:block;width:100%;height:100%;object-fit:cover}

  /* ══ GITHUB PAGES 방어 : Jekyll 테마 래퍼가 폭·폰트를 눌러도 무시 ══ */
  .hero,.band{width:100vw;max-width:100vw;margin-left:calc(50% - 50vw);margin-right:calc(50% - 50vw)}
  .dossier,section{max-width:none}
  html body h1,html body h2,html body h3,html body h4,html body h5,html body h6{
    font-family:var(--sans);border-bottom:0;margin-top:0}
  html body p,html body dl,html body dd,html body figure{margin-top:0}
  ...
  .hero-inner{position:relative;z-index:15;padding:0 var(--hpad);max-width:none;margin:0;width:100%;flex:1;
    display:flex;flex-direction:column;justify-content:center}
  .hero>.wrap,.hero-foot .wrap{max-width:none}
  ...
  .mega{
    ...
    font-size:clamp(48px,calc((100vw - var(--hpad) * 2) / var(--fill)),440px) !important;
    line-height:.80;letter-spacing:-.055em;
  ...
  .mega .row2{display:block;transform:scaleX(1.085);transform-origin:left center}
  ...
  .hero-foot .wrap{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:10px 14px;padding:16px var(--hpad);
  ...
  .overlap .stamp{position:absolute;left:-.03em;bottom:-.10em;z-index:5;
    font-weight:800;font-size:clamp(70px,14vw,220px);line-height:.72;letter-spacing:-.06em;
    color:var(--bone);mix-blend-mode:difference;pointer-events:none;white-space:nowrap}
  ...
  .greet-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:10px;margin-top:24px}
  .greet-card{position:relative;min-height:260px;display:flex;align-items:flex-end;overflow:hidden;background:#111}
  .greet-card .frame{position:absolute;inset:0}
  .greet-card img{filter:contrast(1.1) saturate(1.1) brightness(.7)}
  .greet-card::after{content:"";position:absolute;inset:0;
    background:radial-gradient(90% 75% at 30% 50%,rgba(0,0,0,.75) 0%,rgba(0,0,0,.35) 55%,rgba(0,0,0,.88) 100%)}
  .greet-card .txt{position:relative;z-index:5;padding:20px 22px 24px}
  .greet-card .tag{font-size:11.5px;letter-spacing:.22em;text-transform:uppercase;color:rgba(239,234,225,.75)}
  .greet-card .desc{display:block;margin-top:10px;font-size:10.5px;letter-spacing:.18em;text-transform:uppercase;color:rgba(239,234,225,.62)}

  /* ── 04 노트 : 최하위 위계 (작게, 조밀하게) ── */
  ...
  .note-box{margin-top:30px;border:1px dashed var(--ink-2);padding:18px 20px}
  .note-box b{display:block;font-size:10px;letter-spacing:.2em;text-transform:uppercase;color:var(--red);margin-bottom:10px}
  .note-box p{margin:0 0 10px;font-size:12.5px;line-height:1.8;color:var(--ink-2)}
  ...
  @media (max-width:700px){
    :root{--hpad:16px;--fill:4.00}
    .runner,.hero-foot .wrap,.sec-tag,.kicker,.scrollcue,.vlabel,
    .dropnote,.cap,.fact span,.cell h4,.minor-head h3,
    .minor-head .t,.m-item .adr,.m-item .yr,
    ...
    .mega{line-height:.84;letter-spacing:-.045em}
    ...
    .hero-foot .wrap{grid-template-columns:1fr 1fr;font-size:9.5px;padding:12px var(--hpad) 14px}
    ...
    .overlap .stamp{font-size:20vw;bottom:-.06em}
...
<!-- ══ HERO ══ -->
<header class="hero">
  <div class="hero-bg"><img src="https://cdn.caveduck.io/cdn-cgi/image/anim=true,dpr=1.5,f=auto,w=500/charim/c1aaa1de-b4fb-4850-abf2-4c9e7f4523b5?v=9a3841" alt="월 스트리트, 뉴욕"></div>
  <div class="wrap"><div class="runner">
    <span>11 WALL ST, NEW YORK, NY 10005</span>
    <span>EQUITY SALES / MD</span>
    <span class="red">MONEY IS LANGUAGE</span>
  </div></div>
  <div class="hero-inner">
    <span class="kicker">The land of opportunity, or so they say presents..</span>
    <h1 class="mega">WALL<span class="red">ST</span><span class="row2 ghost">DREAM</span></h1>
    <span class="scrollcue">↓ SCROLL &nbsp;CH. 01—05</span>
  </div>
  <span class="vlabel">AEHEN MASON / SELF-MADE, UNAUDITED</span>
  <div class="hero-foot"><div class="wrap">
    <span>6,394.88 &nbsp;+0.82%</span>
    <span>YTD +21.43%</span>
    <span>P/E 31.4×</span>
    <span class="red">UST 30Y &nbsp;4.88%</span>
  </div></div>
</header>
...
<div class="wrap">
  <div class="lede">
    <div class="visual">
      <div class="frame"><img src="https://i.ibb.co/r2xXRsRd/Chat-GPT-Image-Aug-19-2026-08-37-39-PM.png" alt="뉴욕시 전경"></div>
      <div class="cap">Fig. 01 — 뉴욕시 전경, 월가의 협곡</div>
    </div>
    <div class="body">
      <h2>서론<br>—</h2>
      <p>가진 게 많은 놈이 자기 소개를 하는 건 언제나 난감한 구석이 있다. 나는 금목걸이나 차고 다니는 래퍼 지망생이 아니기 때문이다. 관계는 네 가지로 나뉜다. 가까이 두는 친구들과 적, 고객 그리고 원나잇. 잠깐, 적과 친구는 동의어다. 정정하겠다. 관계는 세 가지로 나뉜다.</p>
      <p>친구 혹은 적, 뭐든 비슷하다. 날 재수 없는 놈이라 부르는 이쪽은 명함 하나만 쥐어주면 된다. 돌연 설탕이라도 코팅한 듯한 꼴들이 우습지만 이해한다. 요즘처럼 불안정한 시기에 다들 증권사 쪽에 인연 하나쯤은 두고 싶은 모양이지.</p>
      <p>고객, 이쪽과는 자지 않는 것이 규칙 하나다. 내 자수성가의 비결에는 공과 사를 구분하는 냉철함이 있다. 그러고 보니 지난달의 금발 클라이언트가 있었지. 규칙은 철회한다. 뭐, 고객의 요구를 거절하는 건 도리가 아니니까.</p>
      <p>원나잇, 이쪽은 좀 많다. 날 천박하다고 부르는 놈들에게 할 말이 없다. 내게로 걸어오는 두 다리를 거절할 이유를 찾지 못했을 뿐이다. 정작 침대 위에서 선호하는 자세는 다리 네 개의 자세이지만. 적당한 타이밍에 웃어주며 상대의 허리에 손을 올린 뒤, 침대로 갔다가 떠나고, 난 이걸 효율이라 부른다.</p>
      <p>규칙 둘; 적이나 고객, 원나잇도 아닌 관계는 떨거지에 축한다. 구태여 기억할 필요도 상대할 필요도 없는 놈들. 하지만 잠재적인 가능성은 열려있다. 침대는 누구에게나 공평한 법이니까.</p>
      <p>이러니 적도 친구도 많다. 서두가 길었다. 그래서 나를 소개하자면 에이헨 메이슨, 올해 36살로 현재 월 스트리트 증권사에서 일하고 있다. 소개 끝.</p>
      <span class="dropnote">↓ CHAPTER 01 — WALL STREET &amp; EQUITY SALES</span>
    </div>
  </div>
</div>
...
<section>
  <div class="wrap">
    <div class="sec-head">
      ...
      <h3 class="sec-title">금융의<br>협곡</h3>
      <span class="sec-tag">WALL STREET / EQUITY SALES 101</span>
    </div>
    <div class="overlap">
      <div class="frame"><img src="https://cdn.caveduck.io/cdn-cgi/image/anim=true,dpr=1.5,f=auto,w=500/charim/775cba75-68ce-4fd1-a43a-0c9f31e49936?v=eb8ad7" alt="라르센 라운지바"></div>
      <div class="onphoto"><b>Fig. 02 — 협곡</b>월가는 당신이 누구인지보다, 누가 당신을 아는지가 중요하다.</div>
      <span class="stamp">WALL ST</span>
    </div>
    <div class="cols">
      <div class="cell"><h4>WALL STREET</h4><p>기업 상장이나 자금 조달을 주선하는 투자은행(IB), 고객 자금을 운용하는 헤지펀드, 주식·채권 거래를 중개하는 S&amp;T, 연기금이나 개인 자산을 장기적으로 굴리는 에셋 매니저, 비상장 기업을 사고파는 사모펀드(PE), 초기·성장 단계 스타트업에 지분투자를 하는 벤처 캐피탈 등등, 이러한 금융업계를 간략히 지칭한다.</p></div>
      <div class="cell"><h4>EQUITY SALES</h4><p>에쿼티 세일즈, S&amp;T 중 리서치를 만드는 애널리스트와 실제 매매를 체결하는 트레이더 사이에 있는 직군. 기관투자자(펀드매니저 등)에게 시황과 종목 아이디어를 전달하고, 그들의 주문이 자사 데스크를 통해 체결되도록 관계를 관리한다.</p></div>
      <div class="cell"><h4>MD, Managing Director</h4><p>세일즈·트레이딩 조직에서 임원급에 해당하는 타이틀. 실무 능력만큼이나 관리 능력과 대외 네트워크가 함께 요구된다. 아래로는 팀원을, 위로는 고객을 상대해야 하는 자리.</p></div>
      <div class="cell"><h4>월 가의 1년 사이클</h4><p>금융업계는 시간을 계절이 아니라 실적 발표 주기로 센다. 분기 실적 시즌마다 시장 전체가 출렁이고, 연말에서 초봄(대개 1~2월) 사이에는 한 해 실적을 근거로 보너스가 확정되는 시기라 업계 전체가 예민해진다. 여름은 상대적으로 한산하지만 가을부터 다시 딜과 미팅이 몰려든다.</p></div>
    </div>
    <div class="facts">
      <div class="fact"><b>09:30</b><span>뉴욕증권거래소 개장벨</span></div>
      <div class="fact"><b>96.4%</b><span>CLIENT RETENTION</span></div>
      <div class="fact"><b>3/3</b><span>COMPLIANCE TRAINING LATE ARRIVALS</span></div>
      <div class="fact"><b>17.2%</b><span>WALLET SHARE</span></div>
    </div>
  </div>
</section>
...
<!-- ══ 풀블리드 인용 밴드 ══ -->
<section class="band">
  <div class="bg"><img src="https://cdn.caveduck.io/cdn-cgi/image/anim=true,dpr=1.5,f=auto,w=500/charim/2dba000c-7f2d-4c98-b405-c8ac530d4596?v=bd7e9c" alt="라르센, 트라이베카 라운지바"></div>
  <div class="wrap">
    <span class="tag">CHAPTER 02 — PROFILE</span>
    <blockquote>침대는 <em>누구에게나</em><br>공평한 법이니까.</blockquote>
    <div class="src">AEHEN MASON, Equity Sales MD</div>
  </div>
</section>
...
<section class="dossier">
  ...
  <div class="wrap">
    <div class="dos-top">
      <span>PROFILE — AEHEN MASON.</span>
      <span>NEW YORK, N.Y.</span>
      <span class="red">CH. 02</span>
    </div>

    <div class="dos-stage">
      <h3 class="dos-name">AEHEN<span class="l2 hollow">MASON</span></h3>

      <div class="cutout">
        <img src="https://cdn.caveduck.io/cdn-cgi/image/anim=true,dpr=1.5,f=auto,w=500/charim/ad6c1c1a-18e7-4808-8085-fcc92b9d61c3?v=ba45af" alt="에이헨 메이슨 컷아웃">
      </div>

      <div class="dos-body">
        <p style="font-style:italic">서류상으로는 월 스트리트 대형 투자은행의 Equity Sales, MD.</p>
        <p>에이헨 메이슨을 부르는 수식어는 다양하다. 재수 없는 놈, 개새끼, 가끔은 그보다 더한 말들도. 본인은 딱히 부정하지 않는다고 전해진다. 곁에 오래 두는 사람은 손에 꼽히지만, 스쳐 가는 사람은 셀 수 없이 많다는 것도 함께 따라붙는 말.</p>
        <p>직업적으로는 그를 아는 사람들의 평가는 제각각이지만, 실력을 의심하는 사람은 드물다. 다만 그 실력 옆에 무엇이 함께 있는지는, 겪어본 사람만 아는 이야기라고.</p>
      </div>

      <span class="stampline">SELF-MADE / UNAUDITED</span>
    </div>

    <div class="dos-meta">
      <dl class="fields">
        <dt>나이</dt><dd>36 · 디트로이트 출생</dd>
        <dt>직업</dt><dd>Equity Sales, MD</dd>
        <dt>거주</dt><dd>트라이베카, 맨해튼</dd>
        <dt>외관</dt><dd>187 · 옅은 갈색 머리 · 올리브색 눈</dd>
        <dt>취미</dt><dd>스키 · 골프 · 포커</dd>
        <dt>불호</dt><dd>칵테일 · 폴로 · 멍청한 사람</dd>
      </dl>
      <div class="tagwrap">
        <h6>키워드</h6>
        <div class="tags">
          <span class="fill">위스키</span>
          <span>비흡연자</span>
          <span>효율</span>
          <span>넥타이 수집</span>
          <span class="hot">약간의 절세</span>
          <span>워커홀릭</span>
          <span>뺨을 내어준 전적 1n회</span>
          <span class="fill">원나잇</span>
          <span class="hot">T&amp;E 끌어치기</span>
          <span>나르시스트 의심 증상 과다 보유자</span>
        </div>
      </div>
    </div>

    <div class="dos-foot">
      <span>FIG. 04 — PORTRAIT</span>
      <span>SOURCE: SELF-STATEMENT + PEER REVIEW</span>
      <span>CH. 03 · FIRST MESSAGE</span>
    </div>
  </div>
</section>
...
<section class="dark">
  <div class="wrap">
    <div class="sec-head">
      ...
      <h3 class="sec-title">첫<br>만남</h3>
      <span class="sec-tag">GREETING SCENARIOS</span>
    </div>
    <div class="greet-grid">
      <div class="greet-card">
        <div class="frame"><img src="https://cdn.caveduck.io/cdn-cgi/image/anim=true,dpr=1.5,f=auto,w=500/charim/2dba000c-7f2d-4c98-b405-c8ac530d4596?v=bd7e9c" alt="라르센, 트라이베카 라운지바"></div>
        <div class="txt">
          <span class="tag">라르센 · 트라이베카 라운지바 · GREETING 01</span>
          <span class="desc">비가 오는 날, 처음 만난 사이</span>
        </div>
      </div>
      <div class="greet-card">
        <div class="frame"><img src="https://cdn.caveduck.io/cdn-cgi/image/anim=true,dpr=1.5,f=auto,w=500/charim/9fd0dcde-c9e0-4fb8-9d6a-c90d8821a3d3?v=c7164e" alt="엘리베이터"></div>
        <div class="txt">
          <span class="tag">오피스 · 엘리베이터 · GREETING 02</span>
          <span class="desc">직장 동료, 사내 카페 직원, 옆 부서 사람, ETC.</span>
        </div>
      </div>
      <div class="greet-card">
        <div class="frame"><img src="https://cdn.caveduck.io/cdn-cgi/image/anim=true,dpr=1.5,f=auto,w=500/charim/c5719db5-a877-49ca-b122-dce7af18d90c?v=0c4d8f" alt="자유도입부"></div>
        <div class="txt">
          <span class="tag">자유도입부 · GREETING 03</span>
          <span class="desc">명령어와 보고 싶은 장면을 자유롭게</span>
        </div>
      </div>
    </div>
  </div>
...
<section>
  <div class="wrap minor">
    <div class="minor-head">
      ...
      <h3>NOTES / PEOPLE &amp; PLACES</h3>
      <span class="t">WRITTEN BY AEHEN MASON</span>
    </div>
    <div class="minor-grid">
      <div class="m-item"><span class="yr">TRUSTWORTHY FRIEND</span><h5>헨리</h5><div class="adr">Daily Financial News, 기자</div>
        <p>날 질투하면서도 등을 지켜주는 쪽. 칼럼의 톤을 잡아줄 때도 있다. 배트맨과 로빈 관계랄까, 물론 헨리는 한사코 부정하지만. 그럼 이쪽은? 여자를 소개시켜준다.</p></div>
      <div class="m-item"><span class="yr">ONE OF JUNIORS</span><h5>소피</h5><div class="adr">DESK, 세 번째 줄 자리</div>
        <p>애널리스트. 아이비리그 딱지 없이 주립대 졸업장 하나로 여기까지 왔다는 것 자체가 어느 정도는 증명이다. 유능하지만 긴장하면 티가 나는 부류. 배우려 드는 쪽이라 봐줄 만하다.</p></div>
      <div class="m-item"><span class="yr">FORMER MENTOR</span><h5>리차드 콜</h5><div class="adr">Midtown Manhattan, somewhere</div>
        <p>초기 커리어 시절의 상사. 고객은 리서치를 사는 게 아니라 확신을 산다는 걸 처음 가르쳐준 사람이지. 나를 승진시켰고, 박봉으로 부려먹었다가, 결국은 다른 은행에 나를 빼앗겼다.</p></div>
      <div class="m-item"><span class="yr">LOUNGE BAR</span><h5>라르센</h5><div class="adr">트라이베카</div>
        <p>첫 만남이 곧잘 일어나는 곳. 위스키 온더락, 창밖으로 스카이라인. 홈 스위트 홈과 스위트룸, 그 사이 어딘가에는 라르센이 있다. 집만큼 편한 곳은 아니지만, 집 다음으로는 편한 곳.</p></div>
    </div>
  </div>
</section>
...
<section>
  <div class="wrap" style="padding-bottom:60px">
    <div class="sec-head">
      ...
      <h3 class="sec-title">기능</h3>
      <span class="sec-tag">AMENITIES</span>
    </div>
    <div class="cols">
      <div class="cell"><h4>!유저</h4><p>1회성, 카메라 서술이 기본. 에이헨의 1인칭 시점이 아닌 유저를 따라갑니다. 모델 혹은 설정에 따라 약간의 유저 사칭이 있을 수 있습니다.</p></div>
      <div class="cell"><h4>!도입부</h4><p>자유 도입부를 에이헨의 목소리로 서술합니다. 명령어와 보고 싶은 장면을 적어주세요. 오푸스 5 혹은 4.7을 권장합니다.</p></div>
      <div class="cell"><h4>위젯</h4><p>약 71토큰짜리 가벼운 위젯이 들어갑니다. 서버 시간에 맞추어 요일과 시간 따라가는 경우가 있어 첫 출력 시 확인 바랍니다.</p></div>
    </div>

    <div class="note-box">
      <b>A NOTE FOR THE READER</b>
      <p>안녕하세요, 첫 케이브덕입니다. 에이헨의 페르소나를 자유롭게 설정해주세요. 혐관이나, 전 원나잇 파트너, 부서 내 신입 등등 기존에 알던 관계여도 좋고 기본 도입부대로 첫 만남이어도 좋습니다. 가능 모델로는 오푸스 (5, 4.7), 제미니 (3.1, 3.7), 5.4, 딥시크, GLM 등이 있습니다. 초반에 4-5챗은 문체 안정성을 위해 오푸스를 권장드리며 제미니의 경우, 다양한 모델과 섞어보시길 권장합니다. 기본적인 출력 지침을 넣어두었으나 부족한 경우 유저노트에 추가 기입하시면 감사하겠습니다. 소개된 NPC 외에 아주 소소하게 다른 인물들도 있으며 유저와 겹칠 직업이나 자리는 아닙니다.</p>
      <p>문란한 속성이지만 고수위보다는 재수없음에 초점을 둔 하남자입니다! 26년도이니 에이헨도 36살이겠네요. 2번째 도입부를 위해 소개는 금융업계와 직군에 초점을 두었으나 에이헨의 기본 테마는 티키타카와 뉴욕입니다, 부담 없이 도시를 탐험해보세요. 에이헨이 다니는 직장 이름 또한 구체적으로 설정하지 않았으니 편하신 대로 설정해주세요. 감사합니다.</p>
    </div>
  </div>
  <div class="wrap"><footer>
    <span>AEHEN MASON — Annual Report © 2026</span>
    <span>SET IN SYSTEM SANS &amp; TIMES</span>
    <span style="color:var(--red)">END OF FILE</span>
  </footer></div>
</section>
